...
!function e(t, n, i) {
    ...
    2: [function (e, t, n) {
        t.exports = function (t) {
            ...
            var a = t.helpers, o = e("./helpers.js")(t), r = e("./events.js")(t), l = t.Annotation.types;
            return {
                beforeInit: function (e) {
                    var t = e.options, i = e.annotation = {
                        elements: {},
                    ...
                    e.ensureScalesHaveIDs(), t.scales && (i.supported = !0, a.each(t.scales.xAxes, n), a.each(t.scales.yAxes, n))
                },
                beforeUpdate: function (e) {
                    ...
                    if (t.supported) {
                        ...
                        t.options.annotations.forEach(function (i) {
                            var a = i.id || o.objectId();
                            if (!t.elements[a] && l[i.type]) {
                                var r = l[i.type], s = new r({id: a, options: i, chartInstance: e});
                                s.initialize(), t.elements[a] = s, i.id = a, n.push(a)
                            } else t.elements[a] && n.push(a)
                ...
                afterInit: function (e) {
                    ...
                    if (a.isArray(t) && t.length > 0) {
                        var n = e.chart.canvas, i = r.dispatcher.bind(e);
                        r.collapseHoverEvents(t).forEach(function (t) {
                            a.addEvent(n, t, i), e.annotation.onDestroy.push(function () {
                                a.removeEvent(n, t, i)
                            })
                        })
                    }
    ...
    3: [function (e, t, n) {
        t.exports = function (e) {
            var t = e.helpers, n = e.Element.extend({
                initialize: function () {
    ...
    4: [function (e, t, n) {
        t.exports = function (t) {
            ...
            function i(e) {
                var t = this.annotation, i = o.elements(this), r = a.getRelativePosition(e, this.chart),
                    l = o.getNearestItems(i, r), s = n(t.options.events), c = t.options.dblClickSpeed, u = [],
                    f = o.getEventHandlerName(e.type), d = (l || {}).options;
                if ("mousemove" === e.type && (l && !l.hovering ? ["mouseenter", "mouseover"].forEach(function (t) {
                    var n = o.getEventHandlerName(t), i = o.createMouseEvent(t, e);
                    ...
                    if (t.hovering) {
                        ...
                        ["mouseout", "mouseleave"].forEach(function (i) {
                            var a = o.getEventHandlerName(i), r = o.createMouseEvent(i, e);
                            "function" == typeof n[a] && u.push([n[a], r, t])
                        })
                    }
            ...
            var a = t.helpers, o = e("./helpers.js")(t);
    ...
    5: [function (e, t, n) {
        ...
        function l(e, t, n) {
            ...
            e[i + t] || (e[t] ? (e[i + t] = e[t].bind(e), e[t] = function () {
                var a = [e[i + t]].concat(Array.prototype.slice.call(arguments));
                return n.apply(e, a)
            }) : e[t] = function () {
        ...
        function u(e, t) {
            try {
                ...
                try {
                    ...
                    return o.initEvent(e, t.canBubble, t.cancelable), o
                }
            }
        }
        ...
        t.exports = function (e) {
            ...
            function f(e) {
                var t = n(e.id, a(e.chart), e.min, e.max);
            ...
            function d(e, t) {
                ...
                return e.filter(function (e) {
                    ...
                    var a = i.getCenterPoint(), o = h.distanceBetweenPoints(t, a);
                    return o < n ? (e = [i], n = o) : o === n && e.push(i), e
                }, []).sort(function (e, t) {
                    var n = e.getArea(), i = t.getArea();
    ...
    6: [function (e, t, n) {
        ...
        var a = e("./annotation.js")(i);
        t.exports = a, i.pluginService.register(a)
    }, {"./annotation.js": 2, "./element.js": 3, "./types/box.js": 7, "./types/line.js": 8, "chart.js": 1}],
    7: [function (e, t, n) {
        t.exports = function (t) {
            var n = e("../helpers.js")(t), i = t.Annotation.Element.extend({
                setDataLimits: function () {
                    var e = this._model, t = this.options, i = this.chartInstance, a = i.scales[t.xScaleID],
                        o = i.scales[t.yScaleID], r = i.chartArea;
                    e.ranges = {}, a && (min = n.isValid(t.xMin) ? t.xMin : a.getPixelForValue(r.left), max = n.isValid(t.xMax) ? t.xMax : a.getPixelForValue(r.right), e.ranges[t.xScaleID] = {
                        min: Math.min(min, max),
                        max: Math.max(min, max)
                    }), o && (min = n.isValid(t.yMin) ? t.yMin : o.getPixelForValue(r.bottom), max = n.isValid(t.yMax) ? t.yMax : o.getPixelForValue(r.top), e.ranges[t.yScaleID] = {
                        min: Math.min(min, max),
                        max: Math.max(min, max)
                    })
                }, configure: function () {
                    ...
                    var e = this._view, t = this.chartInstance.chart.ctx;
                    ...
                    var n = e.right - e.left, i = e.bottom - e.top;
    ...
    8: [function (e, t, n) {
        t.exports = function (t) {
            function n(e) {
                var t = (e.x2 - e.x1) / (e.y2 - e.y1), n = e.x1 || 0;
                this.m = t, this.b = n, this.getX = function (i) {
                    ...
                    n = n || .001;
                    var i = this.getY(e), a = this.getX(t);
                    return (!isFinite(i) || Math.abs(t - i) < n) && (!isFinite(a) || Math.abs(e - a) < n)
                }
            }

            function i(e, t, n, i, a) {
                var o = e.line, s = {}, c = 0, u = 0;
                switch (!0) {
                    case e.mode == l && "top" == e.labelPosition:
                        u = a + e.labelYAdjust, c = t / 2 + e.labelXAdjust, s.y = e.y1 + u, s.x = (isFinite(o.m) ? o.getX(s.y) : e.x1) - c;
                        break;
                    case e.mode == l && "bottom" == e.labelPosition:
                        u = n + a + e.labelYAdjust, c = t / 2 + e.labelXAdjust, s.y = e.y2 - u, s.x = (isFinite(o.m) ? o.getX(s.y) : e.x1) - c;
                        break;
                    case e.mode == r && "left" == e.labelPosition:
                        c = i + e.labelXAdjust, u = -(n / 2) + e.labelYAdjust, s.x = e.x1 + c, s.y = o.getY(s.x) + u;
                        break;
                    case e.mode == r && "right" == e.labelPosition:
                        c = t + i + e.labelXAdjust, u = -(n / 2) + e.labelYAdjust, s.x = e.x2 - c, s.y = o.getY(s.x) + u;
                        break;
                    default:
            ...
            var a = t.helpers, o = e("../helpers.js")(t), r = "horizontal", l = "vertical",
                s = t.Annotation.Element.extend({
                    setDataLimits: function () {
                        var e = this._model, t = this.options;
                        e.ranges = {}, e.ranges[t.scaleID] = {min: t.value, max: t.endValue || t.value}
                    }, configure: function () {
                        var e, t, l = this._model, s = this.options, c = this.chartInstance, u = c.chart.ctx,
                            f = c.scales[s.scaleID];
                        if (f && (e = o.isValid(s.value) ? f.getPixelForValue(s.value) : NaN, t = o.isValid(s.endValue) ? f.getPixelForValue(s.endValue) : e), !isNaN(e)) {
                            var d = c.chartArea;
                            l.clip = {
                                x1: d.left,
                                x2: d.right,
                                y1: d.top,
                                y2: d.bottom
                            }, this.options.mode == r ? (l.x1 = d.left, l.x2 = d.right, l.y1 = e, l.y2 = t) : (l.y1 = d.top, l.y2 = d.bottom, l.x1 = e, l.x2 = t), l.line = new n(l), l.mode = s.mode, l.labelBackgroundColor = s.label.backgroundColor, l.labelFontFamily = s.label.fontFamily, l.labelFontSize = s.label.fontSize, l.labelFontStyle = s.label.fontStyle, l.labelFontColor = s.label.fontColor, l.labelXPadding = s.label.xPadding, l.labelYPadding = s.label.yPadding, l.labelCornerRadius = s.label.cornerRadius, l.labelPosition = s.label.position, l.labelXAdjust = s.label.xAdjust, l.labelYAdjust = s.label.yAdjust, l.labelEnabled = s.label.enabled, l.labelContent = s.label.content, u.font = a.fontString(l.labelFontSize, l.labelFontStyle, l.labelFontFamily);
                            var h = u.measureText(l.labelContent).width, b = u.measureText("M").width,
                                m = i(l, h, b, l.labelXPadding, l.labelYPadding);
                            l.labelX = m.x - l.labelXPadding, l.labelY = m.y - l.labelYPadding, l.labelWidth = h + 2 * l.labelXPadding, l.labelHeight = b + 2 * l.labelYPadding, l.borderColor = s.borderColor, l.borderWidth = s.borderWidth, l.borderDash = s.borderDash || [], l.borderDashOffset = s.borderDashOffset || 0
                        }
                    }, inRange: function (e, t) {
                        var n = this._model;
